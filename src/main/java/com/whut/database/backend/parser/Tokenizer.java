...
public class Tokenizer {
    ...
    private boolean flushToken; // 是否刷新获取下一个token
    ...
    /*
        弹出了一个token，下次获取的时候需要刷新获取新的token
     */
    public void pop(){
        flushToken = true;
    }
    ...
    private String nextMetaState() throws Exception{
        ...
        }else if(isAlphaBeta(b) || isDigit(b)){ // 是数字或者字母
